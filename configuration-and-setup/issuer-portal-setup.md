...
The issuer portal supports an issuance flow, that is triggered from the directly issuer portal into the SSI wallet. To support this kind of issuance flow, you need to configure the known wallets and their how to connect to them:
